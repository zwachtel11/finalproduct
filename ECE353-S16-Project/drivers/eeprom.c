...
void setup_eeprom(void)
{
  ...
  char write_data1[80] = "Zachary Wachtel";
  char write_data2[80] ="Kevin Zhou";
  char write_data3[2] = "38";
  ...
  for(i = 0; i < 80; i++)
  {
    eeprom_byte_write(EEPROM_I2C_BASE,i,write_data1[i]);
  }
  for(i = 0; i < 80; i++)
  {
    eeprom_byte_write(EEPROM_I2C_BASE,i+80,write_data2[i]);
  }
  for(i = 0; i < 2; i++)
  {
    eeprom_byte_write(EEPROM_I2C_BASE,i+160,write_data3[i]);
  }
